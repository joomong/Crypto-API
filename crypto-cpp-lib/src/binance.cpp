...
void Binance::GetAccountInfo(Json::Value &json_result,const long recvWindow)
{
...
void Binance::GetUserStreamKey(Json::Value &json_result, const long recvWindow)
{
    if (API_KEY.size() == 0) {
